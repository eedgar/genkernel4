...
buildroot_compile::()
{
    ...
    config_set .config BR2_PACKAGE_IPSEC_TOOLS y
    config_set .config BR2_PACKAGE_IPSEC_TOOLS_ADMINPORT y
    config_set .config BR2_PACKAGE_IPSEC_TOOLS_NATT y
    config_set .config BR2_PACKAGE_IPSEC_TOOLS_FRAG y
    config_set .config BR2_PACKAGE_IPSEC_TOOLS_STATS y
    config_set .config BR2_PACKAGE_IPSEC_TOOLS_IPV6 y
    config_set .config BR2_PACKAGE_IPSEC_TOOLS_LIBS y
